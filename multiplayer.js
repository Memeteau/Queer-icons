(() => {
  ...
  document.getElementById('nextBtn').addEventListener('click',e=>{if(!active)return;e.preventDefault();e.stopImmediatePropagation();if(isHost){originalNext();phase='play';syncPlay()}else send('action',{action:'next'})},true);
